# 🤗 Japanese Hugging Face Dataset Catalog

A project that automatically collects and publishes Japanese language Hugging Face datasets as a web page.

## 📋 Project Structure

```
Japanese-HF-datasets-catalog/
...
│       ├── japanese_datasets.json
│       ├── japanese_datasets.csv
│       └── statistics.json
├── scripts/                 # Data collection scripts
│   └── collect_japanese_datasets.py
├── .github/
│   └── workflows/
...
git init
git add .
git commit -m "Initial commit: Japanese HF datasets catalog"
git branch -M main
...
- **Manual Updates**: You can manually run the `Update Japanese Datasets` workflow from the GitHub Actions tab

## 📊 Features

### Website Features
- ✅ Display Japanese dataset list
...
https://songys.github.io/Japanese-HF-datasets-catalog/
